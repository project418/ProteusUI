<template>
    <div class="min-h-screen flex flex-col items-center justify-center bg-main px-6 py-12">
        ...
        <div class="w-full max-w-[400px] space-y-6">
            <div class="space-y-4">
                <div class="space-y-1.5">
                    <label class="text-xs font-bold text-txt-muted uppercase tracking-wider ml-1">{{ $t('auth.email') }}</label>
                ...
                <div class="space-y-1.5">
                    <div class="flex items-center justify-between px-1">
                        <label class="text-xs font-bold text-txt-muted uppercase tracking-wider">{{ $t('auth.password') }}</label>
                        <a href="#" class="text-[11px] font-bold text-txt-muted hover:text-txt-main transition-colors uppercase tracking-tighter">
            ...
            <div class="relative py-4">
                ...
                <div class="relative flex justify-center text-[10px] uppercase font-bold tracking-widest"><span class="bg-main px-4 text-txt-muted">{{ $t('auth.or') }}</span></div>
            </div>
